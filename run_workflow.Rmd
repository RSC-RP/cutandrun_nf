...
#           sampler1 <- ShortRead::FastqSampler(subset_sheet[x,"read1"], 1e6)
#           set.seed(123)
#           R1 <- ShortRead::yield(sampler1)
#           sampler2 <- ShortRead::FastqSampler(subset_sheet[x,"read2"], 1e6)
#           set.seed(123)
...
# write.table(subset_sheet, "test_data/test_sample_sheet.txt",
