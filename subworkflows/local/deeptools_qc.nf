...
include { DEEPTOOLS_PLOTENRICHMENT } from '../../modules/local/deeptools/plotenrichment.nf'
...
workflow deeptools_qc {
    ...
    bam_bai_ch.cross(beds){ row -> row[0].id } // join by the key name "id"
    ...
    DEEPTOOLS_PLOTENRICHMENT(bam_peaks_ch)
